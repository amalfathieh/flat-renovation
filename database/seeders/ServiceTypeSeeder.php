    ...
    public function run(): void
    {
        ...
        $typesPerService = [
            ...
            'كهرباء' => [
                ...
                ['name' => 'سلك نحاسي 1.5 مم²', 'description' => 'سلك نحاسي للاستخدام في الإضاءة والأحمال الخفيفة', 'unit' => 'متر طولي', 'price' => 1500, 'image' => 'service-type-image/cable_1.5mm.png'],
                ['name' => 'سلك نحاسي 2.5 مم²', 'description' => 'سلك نحاسي للأحمال المتوسطة مثل المقابس الكهربائية', 'unit' => 'متر طولي', 'price' => 2000, 'image' => 'service-type-image/cable_2.5mm.png'],
                ['name' => 'سلك نحاسي 4 مم²', 'description' => 'سلك نحاسي للأحمال العالية مثل المكيفات', 'unit' => 'متر طولي', 'price' => 3000, 'image' => 'service-type-image/cable_4mm.png'],
            ],
        ];
